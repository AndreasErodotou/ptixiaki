...
class NewListing extends Component {
    ...
    postHandler = (event) => {
        ...
        if(document.getElementById("Available From").value===""){
            ...
            newListing.available_from=document.getElementById("Available From").value;
        }
        if(document.getElementById("Available Until").value===""){
            warnings += "Please Fill The Available Until Field \n";
        }else{
            newListing.available_until=document.getElementById("Available Until").value;
        }
    ...
    render() {
        ...
        if(this.props.createNewListing){
            ...
            NewListingForm=(
                ...
                //     </Modal.Header>
                //     <Modal.Body >
                    <div className="border border-info row m-1" id="fullListing">
                                ...
                                <form className="md-form">
                                    <div className="file-field">
                                        <div className="btn btn-outline-info btn-rounded btn-block my-3 waves-effect z-depth-0">
                                            <label for="test">Select Pictures</label>
                                            <span>
