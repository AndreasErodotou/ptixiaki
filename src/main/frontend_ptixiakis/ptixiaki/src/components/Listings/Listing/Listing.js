...
const Listing = props => {
    ...
    return (
        <div className="col-sm-3" onClick={props.listingClicked}>
            <figure className="card card-product border  border-info" id="innerListing" >
                <div className="img-wrap media inner  p-1">
                    <img className="img-responsive media-left" src={data} />
                </div>
                        ...
                        {/* <div className="rating-wrap">
                            <ul className="rating-stars">
                                <li className="stars-active"> 
                                    <i className="fa fa-star"></i><i className="fa fa-star"></i><i className="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i>
                                </li>
                                <li>
                                    <i className="fa fa-star"></i><i className="fa fa-star"></i><i className="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i> 
                                </li>
